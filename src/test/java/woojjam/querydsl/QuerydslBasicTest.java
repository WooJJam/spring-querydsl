...
public class QuerydslBasicTest {
	 ...
	 */
	@Test
	public void join_on_no_releation() throws Exception {
	...
	/**
	 * DB에서 Presentation 로직을 담는건 좋지 않음
	 * SQL Anti Pattern 중 1
	 */
	@Test
	...
	public void findDtoByJPQL() throws Exception {
		List<MemberDto> result = em.createQuery(
				"select new woojjam.querydsl.dto.MemberDto(m.username, m.age) from Member m", MemberDto.class)
			.getResultList();
	...
	private BooleanExpression ageEq(Integer ageCond) {
		return ageCond != null ? member.age.eq(member.age) : null;
	}
